...
export default async function handler(req: NextApiRequest, res: NextApiResponse<Photo[] | { message: string }>) {
  await makeResponseSlow()

  // res.status(500).json({ message: 'This is a message from my server about the error' })
  // return
